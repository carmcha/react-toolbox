...
var factory = function factory(Input) {
  var Dropdown = function (_Component) {
    ...
    function Dropdown() {
      ...
      return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Dropdown.__proto__ || Object.getPrototypeOf(Dropdown)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
      ...
      }, _this.dropdown = null, _this.getDocumentEvents = function () {
        return {
        ...
        var newFoucsedItemIndex = void 0;
        ...
        if (newFoucsedItemIndex || newFoucsedItemIndex === 0) {
          ...
          _this.dropdown.children[newFoucsedItemIndex].focus();
          return false;
        }
        ...
        setTimeout(function () {
          if (me.dropdown) {
            ...
            var currentFocusedItem = (0, _activeElement2.default)((0, _ownerDocument2.default)(me.dropdown));
            // Check to see if the focused element is part of the menu -- in which case we don't want to close the menu.
            if (!(0, _contains2.default)(me.dropdown, currentFocusedItem)) {
